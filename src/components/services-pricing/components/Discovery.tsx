...
const Label = () => {
  ...
  const handleClickOpen = () => {
    window.open(
      "https://forms.zohopublic.in/mytune/form/DiscoveryRequestForm/formperma/y_KP7b_vcd8ofovTetDxmEX_E0VSJy2jkgisZHxsgao",
      "_blank"
    );
  };
  ...
  return (
    <>
      ...
      >
        <DiscoveryForm open={open} handleClose={handleClose} />
      </Box>
    </>
  );
};
